...
# Temporary thread1: inference investigation of data
...
```
You can convert the `denoising-statsNoFilt.qza` file into a `.qzv` file and visualize it on qiime viewer as explained earlier.

![alt text](https://github.com/farhadm1990/Microbiome_analysis/blob/main/Pix/Denoising.PNG)
...
![ASV table in qiime](https://github.com/farhadm1990/Microbiome_analysis/blob/main/Pix/ASV%20table%20in%20qiime.PNG)
...
This `bash` task took around 12h on a cluster with 64G memory capacity. After you got `silva-classifier-primered4.qza` classifier [file](https://www.dropbox.com/s/bcgx9djrk6wrnbw/silva-classifier-341f-805r-v138.qza?dl=0), you can use it for your taxonomic classifications as follows:
...
> **Figure 7**. The unrooted phylogenetic tree generated by SEPP method displayed on iTol.
