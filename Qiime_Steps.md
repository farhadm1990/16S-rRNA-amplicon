...
#
You can now export the artifacts from `qiime` to `R` by `qiime2R` package in R and continue by folloiwng the **[steps in R](https://github.com/farhadm1990/Microbiome_analysis#steps-in-r)**
