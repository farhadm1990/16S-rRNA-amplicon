After we created all artifacts in qiime2 such as ASV table, unrooted tree, taxonomy table and metadata, now we can bring them into R by usign qiime2_R package in R. 
